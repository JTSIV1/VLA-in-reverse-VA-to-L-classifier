#!/bin/bash
#SBATCH --job-name=openvla_ft_vq_verb
...
#SBATCH -o /data/user_data/wenjiel2/Code/VLA-in-reverse-VA-to-L-classifier/logs/openvla_ft_vq_verb-%j.out
#SBATCH -e /data/user_data/wenjiel2/Code/VLA-in-reverse-VA-to-L-classifier/logs/openvla_ft_vq_verb-%j.err
