#!/bin/bash
#SBATCH --job-name=openvla_abcd_ft_vq_vanilla
#SBATCH --partition=general
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=30:00:00
#SBATCH -o /data/user_data/wenjiel2/Code/VLA-in-reverse-VA-to-L-classifier/logs/openvla_abcd_ft_vq_vanilla-%j.out
#SBATCH -e /data/user_data/wenjiel2/Code/VLA-in-reverse-VA-to-L-classifier/logs/openvla_abcd_ft_vq_vanilla-%j.err
...
VQVLA_CKPT="${PROJECT_DIR}/checkpoints/vqvla_ft_vanilla"
...
torchrun --standalone --nnodes 1 --nproc-per-node 1 vla-scripts/finetune.py \
    ...
    --run_id_note calvin_abcd_vq_vanilla \
