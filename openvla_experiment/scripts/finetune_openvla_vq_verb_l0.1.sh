#!/bin/bash
#SBATCH --job-name=openvla_ft_vq_verb01
...
#SBATCH -o /data/user_data/wenjiel2/Code/VLA-in-reverse-VA-to-L-classifier/logs/openvla_ft_vq_verb01-%j.out
#SBATCH -e /data/user_data/wenjiel2/Code/VLA-in-reverse-VA-to-L-classifier/logs/openvla_ft_vq_verb01-%j.err
...
VQVLA_CKPT="${PROJECT_DIR}/checkpoints/vqvla_ft_verb_l0.1"
