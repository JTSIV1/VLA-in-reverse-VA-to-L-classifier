#!/bin/bash
#SBATCH --job-name=droid_extract
#SBATCH --partition=cpu
#SBATCH --time=24:00:00
#SBATCH --mem=16G
#SBATCH --cpus-per-task=4
#SBATCH --array=0-31
#SBATCH --output=logs/droid_extract_%a.out
#SBATCH --error=logs/droid_extract_%a.err
...
python scripts/extract_droid_actions.py \
    --shard_start ${SHARD_START} \
    --shard_end ${SHARD_END} \
    --total_shards 2048 \
    --output_dir /data/user_data/wenjiel2/datasets/droid_actions \
    --cache_dir /tmp/droid_cache_${SLURM_ARRAY_TASK_ID}
