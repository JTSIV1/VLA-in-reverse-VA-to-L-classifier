...
def main():
    ...
    print("\n" + "="*60)
    print("LOADING PREDICTIONS AND BUILDING CONFUSION MATRIX (ACTION GOALS)")
    print("="*60)
    preds_path = os.path.join(RESULTS_DIR, "r8_scene_mlp_preds.json")
    ...
    out_path = os.path.join(RESULTS_DIR, "rsm_confusion_analysis_v2_goals.npz")
    save_dict = {
    ...
    json_path = os.path.join(RESULTS_DIR, "rsm_confusion_correlations_v2_goals.json")
